 ...
 * @author Marcos
 */
public class JDDadosItensProd extends javax.swing.JDialog {

    public boolean sucesso = false;

//    private ControleProduto pProduto;

        public void setDados(ItemPedido itemP, String cod, String nomeProd, String qtdProd, String valorPed){
            txtCodProd.setText((itemP==null)?cod : itemP.getCodProd());
     ...
     * @param modal
     */
    public JDDadosItensProd(Frame parent, boolean modal      ) {
            super(parent, modal);
            initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            JDDadosItensProd dialog = new JDDadosItensProd(new javax.swing.JFrame(), true);
